...
export const checkboxIndicatorVariants = tv({
	...
	variants: {
		...
		color: {
			...
			darkred: tw(
				"group-data-selected:bg-darkred-9 group-data-selected:text-white group-data-selected:shadow-none",
				"group-data-indeterminate:bg-darkred-9 group-data-indeterminate:text-white group-data-indeterminate:shadow-none",
				"group-data-focus-visible:ring-2 group-data-focus-visible:ring-offset-2 group-data-focus-visible:ring-darkred-8",
			),
		},
	},
	compoundVariants: [
		...
		{ variant: "surface", color: "darkred", class: tw("bg-darkred-2 shadow-[inset_0_0_0_1px_var(--color-darkred-6)]") },
