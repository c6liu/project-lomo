...
export function HomeNav() {
	return (
		<header className="w-full bg-[#f5efe4] py-6 px-4 md:px-8">
			<div className="max-w-[1200px] mx-auto relative">
				{/* Black offset backing (shadow) */}
				<div className="absolute inset-0 bg-black rounded-[32px] translate-y-2" />

				{/* Yellow Pill Nav Bar */}
				<div className="relative bg-[#f2c010] border-[3px] border-black rounded-[32px] px-6 py-3 flex items-center justify-between z-10">
					{/* Logo / Brand Name */}
					<Link
						href="/"
